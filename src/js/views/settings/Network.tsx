    ...
    <div className="centered-container">
      ...
      <div id="peers" className="flex-table">
        ...
        <div className="flex-row peer">
          ...
          <div className="flex-cell no-flex">
            <Button onClick={(e) => handleAddRelay(e, newRelayUrl)}>
              {t("add")}
            </Button>
          </div>
        </div>
        <p>
          <Button onClick={() => Relays.saveToContacts()}>
            {t("save_relays_publicly")}
          </Button>
          <Button onClick={() => Relays.restoreDefaults()}>
            {t("restore_defaults")}
          </Button>
        </p>
      </div>
      ...
      <div id="popular-relays" className="flex-table">
        ...
        {popularRelays.map((relay) => (
          <div className="flex-row peer" key={relay.url}>
            ...
            <div className="flex-cell no-flex">
              <Button onClick={(e) => handleAddRelay(e, relay.url)}>
                {t("add")}
              </Button>
            </div>
          </div>
