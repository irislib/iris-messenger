            ...
            <>
                ...
                <div class="chat-new-item">
                    ...
                    <div class="chat-new-item-inner" style="flex-grow: 1" onClick={() => route("/chat/new/QRView")}>
                        <svg fill="currentColor" id="Layer_1" x="0px" y="0px" viewBox="0 0 122.88 122.7" style="enable-background:new 0 0 122.88 122.7; flex-grow: 1; z-index: 10;" width="24px" height="24px">
                            <g>
