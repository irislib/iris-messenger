        ...
        return(
            <>
                ...
                <div class="chat-new-item" >
                    <svg onClick={() => route("/chat/new/InviteView")} class="svg-inline--fa fa-smile fa-w-16" style="margin-right:10px;margin-top:3px; flex-grow: 1" x="0px" y="0px" viewBox="0 0 510 510">
                    ...
                    <p onClick={() => route("/chat/new/InviteView")} style="flex-grow: 8">{t("add_new_contact_or_group")}</p>
                    <svg class="chat-new-item-qrcode" onClick={() => route("/chat/new/QRView")} fill="currentColor" id="Layer_1" x="0px" y="0px" viewBox="0 0 122.88 122.7" style="enable-background:new 0 0 122.88 122.7; flex-grow: 1" width="24px" height="24px">
                        <g>
