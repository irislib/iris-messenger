...
!(function (t, e) {
  ...
  function Et(t) {
    var e = t.rotate,
      ...
      o = t.translateY,
      r = [];
    F(n) && 0 !== n && r.push('translateX('.concat(n, 'px)')),
      F(o) && 0 !== o && r.push('translateY('.concat(o, 'px)')),
      F(e) && 0 !== e && r.push('rotate('.concat(e, 'deg)')),
      F(i) && 1 !== i && r.push('scaleX('.concat(i, ')')),
      F(a) && 1 !== a && r.push('scaleY('.concat(a, ')'));
  ...
  var Yt = {
      ...
      initCanvas: function () {
        ...
        (c.left = (t.width - h) / 2),
          ...
          (this.initialImageData = ht({}, e)),
          (this.initialCanvasData = ht({}, c));
      },
        ...
        if (t) {
          ...
          1 < r
            ? ((c = Math.max(c, a.width)),
              ...
              3 === r && (c < l * h ? (c = l * h) : (l = c / h)))
            : 0 < r &&
              (c
                ? (c = Math.max(c, s ? o.width : 0))
                : l
                ? (l = Math.max(l, s ? o.height : 0))
                : s && ((c = o.width) < (l = o.height) * h ? (c = l * h) : (l = c / h)));
          ...
          if ((s ? 0 : 1) < r) {
            ...
            (n.minLeft = Math.min(0, p)),
              ...
              s &&
                ...
                2 === r &&
                  (n.width >= a.width &&
                    ((n.minLeft = Math.min(0, p)), (n.maxLeft = Math.max(0, p))),
                  n.height >= a.height &&
                    ((n.minTop = Math.min(0, u)), (n.maxTop = Math.max(0, u)))));
          } else
            (n.minLeft = -n.width),
              (n.minTop = -n.height),
              (n.maxLeft = a.width),
      ...
      renderCanvas: function (t, e) {
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          dt(
            this.canvas,
            ht({ width: i.width, height: i.height }, Et({ translateX: i.left, translateY: i.top })),
          ),
          this.renderImage(t),
      ...
      renderImage: function (t) {
        ...
        ht(i, { width: a, height: n, left: (e.width - a) / 2, top: (e.height - n) / 2 }),
          dt(
            this.image,
            ht(
              { width: i.width, height: i.height },
              Et(ht({ translateX: i.left, translateY: i.top }, i)),
            ),
          ),
          t && this.output();
      },
      initCropBox: function () {
        ...
        i && (e.height * i > e.width ? (n.height = n.width / i) : (n.width = n.height * i)),
          (this.cropBoxData = n),
      ...
      renderCropBox: function () {
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          t.movable &&
            t.cropBoxMovable &&
            wt(this.face, m, i.width >= e.width && i.height >= e.height ? k : D),
          dt(
            this.cropBox,
            ht({ width: i.width, height: i.height }, Et({ translateX: i.left, translateY: i.top })),
          ),
    ...
    Xt = {
        ...
        if (
          ...
          'string' == typeof e
            ...
            rt((this.previews = r), function (t) {
              ...
              wt(t, g, { width: t.offsetWidth, height: t.offsetHeight, html: t.innerHTML }),
                i && (e.crossOrigin = i),
                (e.src = a),
                (e.alt = n),
                (e.style.cssText =
      ...
      resetPreview: function () {
        rt(this.previews, function (t) {
          var e = vt(t, g);
          dt(t, { width: e.width, height: e.height }),
            (t.innerHTML = e.html),
            (function (e, i) {
              if (tt(e[i]))
                try {
      ...
      preview: function () {
        ...
        this.cropped &&
          ...
          (dt(
            this.viewBoxImage,
            ht({ width: l, height: d }, Et(ht({ translateX: -p, translateY: -u }, h))),
          ),
          rt(this.previews, function (t) {
            var e = vt(t, g),
              i = e.width,
            ...
            s && (o = c * (r = i / s)),
              c && a < o && ((n = s * (r = a / c)), (o = a)),
              dt(t, { width: n, height: o }),
              dt(
                t.getElementsByTagName('img')[0],
                ht(
                  { width: l * r, height: d * r },
                  Et(ht({ translateX: -p * r, translateY: -u * r }, h)),
                ),
              );
          }));
      },
    ...
    Rt = {
      bind: function () {
        var t = this.element,
          e = this.options,
          i = this.cropper;
        at(e.cropstart) && Mt(t, M, e.cropstart),
          at(e.cropmove) && Mt(t, y, e.cropmove),
          at(e.cropend) && Mt(t, x, e.cropend),
          at(e.crop) && Mt(t, b, e.crop),
          at(e.zoom) && Mt(t, U, e.zoom),
          Mt(i, S, (this.onCropStart = this.cropStart.bind(this))),
          e.zoomable &&
            e.zoomOnWheel &&
            Mt(i, 'wheel', (this.onWheel = this.wheel.bind(this)), { passive: !1, capture: !0 }),
          e.toggleDragModeOnDblclick && Mt(i, R, (this.onDblclick = this.dblclick.bind(this))),
          Mt(t.ownerDocument, A, (this.onCropMove = this.cropMove.bind(this))),
          Mt(t.ownerDocument, j, (this.onCropEnd = this.cropEnd.bind(this))),
          e.responsive && Mt(window, 'resize', (this.onResize = this.resize.bind(this)));
      },
      unbind: function () {
        var t = this.element,
          e = this.options,
          i = this.cropper;
        at(e.cropstart) && yt(t, M, e.cropstart),
          at(e.cropmove) && yt(t, y, e.cropmove),
          at(e.cropend) && yt(t, x, e.cropend),
          at(e.crop) && yt(t, b, e.crop),
          at(e.zoom) && yt(t, U, e.zoom),
          yt(i, S, this.onCropStart),
          e.zoomable && e.zoomOnWheel && yt(i, 'wheel', this.onWheel, { passive: !1, capture: !0 }),
          e.toggleDragModeOnDblclick && yt(i, R, this.onDblclick),
          yt(t.ownerDocument, A, this.onCropMove),
          yt(t.ownerDocument, j, this.onCropEnd),
          e.responsive && yt(window, 'resize', this.onResize);
      },
    },
    St = {
      resize: function () {
      ...
      cropStart: function (t) {
        ...
        if (
          ...
          t.changedTouches
            ...
            : (o[t.pointerId || 0] = Wt(t)),
            (a = 1 < Object.keys(o).length && n.zoomable && n.zoomOnTouch ? O : vt(t.target, m)),
            $.test(a) &&
              !1 !== Ct(this.element, M, { originalEvent: t, action: a }) &&
              (t.preventDefault(),
              (this.action = a),
              (this.cropping = !1),
              a === B && ((this.cropping = !0), pt(this.dragBox, c)));
        }
      },
      cropMove: function (t) {
        var e = this.action;
        if (!this.disabled && e) {
          var i = this.pointers;
          t.preventDefault(),
            !1 !== Ct(this.element, y, { originalEvent: t, action: e }) &&
              (t.changedTouches
                ? rt(t.changedTouches, function (t) {
                    ht(i[t.identifier] || {}, Wt(t, !0));
                  })
                : ht(i[t.pointerId || 0] || {}, Wt(t, !0)),
              this.change(t));
        }
      },
      cropEnd: function (t) {
        if (!this.disabled) {
          ...
          t.changedTouches
            ...
            e &&
              ...
              this.cropping &&
                ((this.cropping = !1), mt(this.dragBox, c, this.cropped && this.options.modal)),
              Ct(this.element, x, { originalEvent: t, action: e }));
        }
      },
    },
    At = {
      change: function (t) {
        ...
        var y = r[Object.keys(r)[0]],
          M = { x: y.endX - y.startX, y: y.endY - y.startY };
        switch (h) {
          case D:
            (c += M.x), (l += M.y);
            break;
          ...
          case H:
            if (s) {
              ...
              x(N),
                x(T),
                0 <= M.x ? (u < v ? (d += M.x) : M.y <= 0 && l <= f && (b = !1)) : (d += M.x),
                M.y <= 0 ? f < l && ((p -= M.y), (l += M.y)) : ((p -= M.y), (l += M.y));
            d < 0 && p < 0
              ? ((h = Y), (l -= p = -p), (c -= d = -d))
              : d < 0
              ? ((h = L), (c -= d = -d))
          ...
          case z:
            if (s) {
              ...
              x(W),
                x(T),
                0 <= M.x ? (u < v ? (d += M.x) : 0 <= M.y && w <= m && (b = !1)) : (d += M.x),
                0 <= M.y ? m < w && (p += M.y) : (p += M.y);
            d < 0 && p < 0
              ? ((h = L), (l -= p = -p), (c -= d = -d))
              : d < 0
          ...
          case B:
            ...
            (e = Dt(this.cropper)),
              ...
              (d = o.minWidth),
              (p = o.minHeight),
              0 < M.x ? (h = 0 < M.y ? z : H) : M.x < 0 && ((c -= d), (h = 0 < M.y ? Y : L)),
              M.y < 0 && (l -= p),
              this.cropped ||
                (ut(this.cropBox, X),
                (this.cropped = !0),
    ...
    jt = {
      crop: function () {
        return (
          !this.ready ||
            ...
            ((this.cropped = !0),
            this.limitCropBox(!0, !0),
            this.options.modal && pt(this.dragBox, c),
            ut(this.cropBox, X),
      ...
      reset: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.imageData = ht({}, this.initialImageData)),
            (this.canvasData = ht({}, this.initialCanvasData)),
            (this.cropBoxData = ht({}, this.initialCropBoxData)),
            this.renderCanvas(),
            this.cropped && this.renderCropBox()),
          this
        );
      ...
      clear: function () {
        return (
          this.cropped &&
            !this.disabled &&
            (ht(this.cropBoxData, { left: 0, top: 0, width: 0, height: 0 }),
            (this.cropped = !1),
            this.renderCropBox(),
            this.limitCanvas(!0, !0),
            this.renderCanvas(),
      ...
      zoomTo: function (t, e, i) {
        ...
        if (0 <= (t = Number(t)) && this.ready && !this.disabled && a.zoomable) {
          var c = h * t,
            l = s * t;
          if (!1 === Ct(this.element, U, { ratio: t, oldRatio: o / h, originalEvent: i }))
            return this;
          if (i) {
            var d = this.pointers,
              p = Dt(this.cropper),
      ...
      getData: function (t) {
        ...
        return (
          ...
          a.scalable && ((i.scaleX = n.scaleX || 1), (i.scaleY = n.scaleY || 1)),
          i
        );
      },
      setData: function (t) {
        ...
        if (this.ready && !this.disabled && it(t)) {
          var o = !1;
          e.rotatable && F(t.rotate) && t.rotate !== i.rotate && ((i.rotate = t.rotate), (o = !0)),
            e.scalable &&
              (F(t.scaleX) && t.scaleX !== i.scaleX && ((i.scaleX = t.scaleX), (o = !0)),
              F(t.scaleY) && t.scaleY !== i.scaleY && ((i.scaleY = t.scaleY), (o = !0))),
            o && this.renderCanvas(!0, !0);
          var r = i.width / i.naturalWidth;
          F(t.x) && (n.left = t.x * r + a.left),
            F(t.y) && (n.top = t.y * r + a.top),
            F(t.width) && (n.width = t.width * r),
            F(t.height) && (n.height = t.height * r),
      ...
      getCanvasData: function () {
        ...
        return (
          this.ready &&
            rt(['left', 'top', 'width', 'height', 'naturalWidth', 'naturalHeight'], function (t) {
              i[t] = e[t];
            }),
          i
        );
      ...
      getCropBoxData: function () {
        ...
        return (
          this.ready &&
            this.cropped &&
            (t = { left: e.left, top: e.top, width: e.width, height: e.height }),
          t || {}
        );
      },
      ...
      getCroppedCanvas: function (t) {
        ...
        var i = this.canvasData,
          a = (function (t, e, i, a) {
            var n = e.aspectRatio,
              ...
              L = Nt({ aspectRatio: u, width: O, height: E }, 'cover'),
              z = Math.min(H.width, Math.max(L.width, m)),
              Y = Math.min(H.height, Math.max(L.height, g)),
              X = Nt({ aspectRatio: n, width: C, height: B }),
              R = Nt({ aspectRatio: n, width: O, height: E }, 'cover'),
        ...
        1 != c && ((o *= c), (r *= c), (h *= c), (s *= c));
        var l = h / s,
          d = Nt({ aspectRatio: l, width: e.maxWidth || 1 / 0, height: e.maxHeight || 1 / 0 }),
          p = Nt({ aspectRatio: l, width: e.minWidth || 0, height: e.minHeight || 0 }, 'cover'),
          u = Nt({
            aspectRatio: l,
        ...
        E <= -h || O < E
          ? (B = C = y = E = 0)
          : E <= 0
          ? ((C = -E), (E = 0), (B = y = Math.min(O, h + E)))
          : E <= O && ((C = 0), (B = y = Math.min(h, O - E))),
          y <= 0 || W <= -s || T < W
            ? (k = D = M = W = 0)
            : W <= 0
      ...
      setDragMode: function (t) {
        ...
        if (this.ready && !this.disabled) {
          ...
          (t = n || o ? t : w),
            ...
            mt(i, h, n),
            mt(i, u, o),
            e.cropBoxMovable || (wt(a, m, t), mt(a, h, n), mt(a, u, o));
        }
        return this;
      },
    },
          ...
          [
                  ...
                  if (
                    ...
                    if (Q.test(t))
                      ...
                      (this.reloading = !0),
                        ...
                        a.checkCrossOrigin && Ot(t) && i.crossOrigin && (t = Tt(t)),
                        n.open('GET', t),
                ...
                if (1 < a) {
                  this.url = (function (t, e) {
                    for (var i = [], a = new Uint8Array(t); 0 < a.length; )
                      i.push(Ht.apply(null, ot(a.subarray(0, 8192)))), (a = a.subarray(8192));
            ...
            },
            {
              ...
              value: function () {
                var t = this.element,
                  ...
                  i = t.crossOrigin,
                  a = e;
                this.options.checkCrossOrigin && Ot(e) && ((i = i || 'anonymous'), (a = Tt(e))),
                  (this.crossOrigin = i),
            ...
            },
            {
              ...
              value: function () {
                ...
                function e(t, e) {
                  ht(i.imageData, { naturalWidth: t, naturalHeight: e, aspectRatio: t / e }),
                    (i.sizing = !1),
                    (i.sized = !0),
                    i.build();
                }
              ...
              value: function () {
                if (this.sized && !this.ready) {
                  ...
                  (this.container = a),
                    ...
                    pt(s, X),
                    e.guides || pt(s.getElementsByClassName(''.concat(l, '-dashed')), X),
                    e.center || pt(s.getElementsByClassName(''.concat(l, '-center')), X),
                    e.background && pt(o, ''.concat(l, '-bg')),
                    e.highlight || pt(c, p),
                    e.cropBoxMovable && (pt(c, u), wt(c, m, D)),
                    e.cropBoxResizable ||
                      (pt(s.getElementsByClassName(''.concat(l, '-line')), X),
                      pt(s.getElementsByClassName(''.concat(l, '-point')), X)),
                    this.render(),
                    (this.ready = !0),
                    this.setDragMode(e.dragMode),
                    e.autoCrop && this.crop(),
                    this.setData(e.data),
                    at(e.ready) && Mt(t, I, e.ready, { once: !0 }),
                    Ct(t, I);
                }
              },
            },
