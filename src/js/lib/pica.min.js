!(function (t) {
  ...
  return (function o(a, A, s) {
    ...
    for (var h = 'function' == typeof require && require, t = 0; t < s.length; t++) u(s[t]);
    return u;
  })(
    {
      1: [
        function (t, e, i) {
          ...
          function A(t) {
            var e = t || [],
              i = { js: 0 <= e.indexOf('js'), wasm: 0 <= e.indexOf('wasm') };
            n.call(this, i),
        ...
        { './mm_resize': 4, inherits: 15, multimath: 16, 'multimath/lib/unsharp_mask': 19 },
      ],
      2: [
        function (t, e, i) {
          'use strict';
          ...
          e.exports = {
            convolveHorizontally: function (t, e, i, r, n, o) {
              ...
              for (l = 0; l < r; l++) {
                for (I = h = 0; I < n; I++) {
                  for (f = o[h++], c = o[h++], g = (m + 4 * f) | 0, a = A = s = u = 0; 0 < c; c--)
                    (u = (u + (d = o[h++]) * t[g + 3]) | 0),
                      (s = (s + d * t[g + 2]) | 0),
                      (A = (A + d * t[g + 1]) | 0),
                      (a = (a + d * t[g]) | 0),
        ...
        function (t, e, i) {
          ...
          e.exports = function (t) {
            ...
            return (
              ...
              c ||
                (function (t, e, i) {
                  for (var r = 3, n = (e * i * 4) | 0; r < n; ) (t[r] = 255), (r = (r + 4) | 0);
                })(h, n, o),
              h
            );
          };
        ...
        function (t, e, i) {
          ...
          e.exports = function (t, e, i, r, n) {
            var o,
              ...
              C = M[t].win / y,
              Q = Math.floor(2 * (1 + C)),
              v = new Int16Array((Q + 2) * i),
              x = 0,
              D = !v.subarray || !v.set;
            for (o = 0; o < i; o++) {
              for (
                a = (o + 0.5) * E + n,
                  A = Math.max(0, Math.floor(a - C)),
                  u = (s = Math.min(e - 1, Math.ceil(a + C))) - A + 1,
                ...
                (c += I = _((g + 0.5 - a) * y)), (h[l] = I);
              for (l = d = 0; l < h.length; l++) (d += m = h[l] / c), (f[l] = U(m));
              for (f[i >> 1] += U(1 - d), p = 0; p < f.length && 0 === f[p]; ) p++;
              if (p < f.length) {
                for (w = f.length - 1; 0 < w && 0 === f[w]; ) w--;
                if (((B = A + p), (b = w - p + 1), (v[x++] = B), (v[x++] = b), D))
                  for (l = p; l <= w; l++) v[x++] = f[l];
                else v.set(f.subarray(p, w + 1), x), (x += b);
              } else (v[x++] = 0), (v[x++] = 0);
            }
            return v;
          };
      ...
      8: [
        function (t, e, i) {
          'use strict';
          var E = t('./resize_filter_gen');
          var a = !0;
          try {
            a = 1 === new Uint32Array(new Uint8Array([1, 0, 0, 0]).buffer)[0];
          } catch (t) {}
          function y(t, e, i) {
            if (a)
              e.set(
          ...
          e.exports = function (t) {
            var e = t.src,
              ...
              g = E(f, i, n, a, s),
              l = E(f, r, o, A, u),
              I = this.__align(0 + Math.max(e.byteLength, h.byteLength)),
              d = this.__align(I + r * n * 4),
              m = this.__align(d + g.byteLength),
              p = m + l.byteLength,
              w = this.__instance('resize', p),
              B = new Uint8Array(this.__memory.buffer),
              b = new Uint32Array(this.__memory.buffer),
              _ = new Uint32Array(e.buffer);
            return (
              b.set(_),
              y(g, B, d),
              y(l, B, m),
              (w.exports.convolveHV || w.exports._convolveHV)(d, m, I, i, r, n, o),
              new Uint32Array(h.buffer).set(new Uint32Array(this.__memory.buffer, 0, o * n)),
              c ||
                (function (t, e, i) {
                  for (var r = 3, n = (e * i * 4) | 0; r < n; ) (t[r] = 255), (r = (r + 4) | 0);
                })(h, n, o),
          ...
          (r.prototype.acquire = function () {
            ...
            (r.prototype.gc = function () {
              ...
              (this.available = this.available.filter(function (t) {
                return !(i - t.lastUsed > e.idle) || (t.destroy(), !1);
              })),
                0 !== this.available.length
                  ? (this.timeoutId = setTimeout(function () {
                      return e.gc();
      ...
      10: [
        function (t, e, i) {
          ...
          e.exports = function (t, e, i, r, n, o) {
            ...
            if (u <= 1) return [[i, r]];
            for (var h = [], f = 0; f < u; f++) {
              var c = Math.round(Math.pow(Math.pow(t, u - f - 1) * Math.pow(i, f + 1), 1 / u)),
                g = Math.round(Math.pow(Math.pow(e, u - f - 1) * Math.pow(r, f + 1), 1 / u));
              h.push([c, g]);
            }
            return h;
          };
        ...
        function (t, e, i) {
          ...
          e.exports = function (t) {
            var e,
              ...
              h = g(t.srcTileSize * s) - 2 * t.destTileBorder;
            if (u < 1 || h < 1)
              throw new Error('Internal error in pica: target tile width/height is too small.');
            var f,
              c = [];
            for (n = 0; n < t.toHeight; n += h)
              for (r = 0; r < t.toWidth; r += u)
                (e = r - t.destTileBorder) < 0 && (e = 0),
                  e + (o = r + u + t.destTileBorder - e) >= t.toWidth && (o = t.toWidth - e),
                  (i = n - t.destTileBorder) < 0 && (i = 0),
                  i + (a = n + h + t.destTileBorder - i) >= t.toHeight && (a = t.toHeight - i),
                  (f = {
                    toX: e,
                    toY: i,
                    toWidth: o,
        ...
        function (t, e, i) {
          ...
          e.exports = function () {
            ...
            onmessage = function (t) {
              var e = t.data.opts,
                i = (r = r || new n(t.data.features)).resizeAndUnsharp(e);
      ...
      14: [
        function (t, e, i) {
          ...
          function g(t, e, i, r, n, o) {
            var a, A, s, u, h, f, c, g, l, I, d, m, p, w;
            for (l = 0; l < o; l++) {
              for (
                g = 0,
                  u = h = (a = t[(f = (c = l) * n)]) * r[6],
          ...
          e.exports = function (t, e, i, r) {
            if (r) {
              var n = new Uint16Array(t.length),
      ...
      16: [
        function (t, e, i) {
          ...
          (A.prototype.has_wasm = n),
            ...
            (A.prototype.init = function () {
              ...
              if (!this.options.js && this.options.wasm && !this.has_wasm())
                return Promise.reject(
                  new Error('mathlib: only "wasm" was enabled, but it\'s not supported'),
                );
              var i = this;
              return (
                (this.__init_promise = Promise.all(
                  Object.keys(i.__modules).map(function (e) {
                    var t = i.__modules[e];
                    return i.options.wasm && i.has_wasm() && t.wasm_fn
                      ? i.__wasm[e]
                        ? null
                        : WebAssembly.compile(i.__base64decode(t.wasm_src)).then(function (t) {
                            i.__wasm[e] = t;
                          })
                      : null;
                  }),
            ...
            (A.prototype.__reallocate = function (t) {
              if (!this.__memory)
                return (
                  (this.__memory = new WebAssembly.Memory({ initial: Math.ceil(t / 65536) })),
                  this.__memory
                );
            ...
            (A.prototype.__instance = function (t, e, i) {
              ...
              if (!this.__cache[t]) {
                ...
                this.__cache[t] = new WebAssembly.Instance(this.__wasm[t], { env: o(n, i || {}) });
              }
        ...
        { './lib/base64decode': 17, './lib/wa_detect': 23, 'object-assign': 24 },
      ],
      17: [
        function (t, e, i) {
          'use strict';
          e.exports = function (t) {
            for (
              ...
              a % 4 == 0 &&
                a &&
                ((r[o++] = (n >> 16) & 255), (r[o++] = (n >> 8) & 255), (r[o++] = 255 & n)),
                (n =
                  (n << 6) |
      ...
      18: [
        function (t, e, i) {
          ...
          e.exports = function (t, e, i) {
            for (var r, n, o, a, A, s = e * i, u = new Uint16Array(s), h = 0; h < s; h++)
              (r = t[4 * h]),
                (n = t[4 * h + 1]),
                (o = t[4 * h + 2]),
                (A = n <= r && o <= r ? r : o <= n && r <= n ? n : o),
      ...
      19: [
        ...
        { './unsharp_mask': 20, './unsharp_mask_wasm': 21, './unsharp_mask_wasm_base64': 22 },
      ],
      20: [
        function (t, e, i) {
          'use strict';
          ...
          e.exports = function (t, e, i, r, n, o) {
            ...
            if (!(0 === r || n < 0.5)) {
              ...
              C(B, e, i, n);
              for (
                var b = ((r / 100) * 4096 + 0.5) | 0, _ = (257 * o) | 0, E = e * i, y = 0;
                y < E;
                y++
              )
                (m = 2 * (w[y] - B[y])),
                  Math.abs(m) >= _ &&
                    ...
                    (f =
                      (257 *
                        ((g = A <= a && s <= a ? a : a <= A && s <= A ? A : s) +
                          (c = a <= A && a <= s ? a : A <= a && A <= s ? A : s))) >>
                      1),
                    (u =
                      c === g
                        ? (h = 0)
                        : ((h =
                          ...
                          a === g
                            ? ((65535 * (A - s)) / (6 * (g - c))) | 0
                            : A === g
                            ? 21845 + (((65535 * (s - a)) / (6 * (g - c))) | 0)
                            : 43690 + (((65535 * (a - A)) / (6 * (g - c))) | 0))),
                    65535 < (f += (b * m + 2048) >> 12) ? (f = 65535) : f < 0 && (f = 0),
                    0 === h
                      ? (a = A = s = f >> 8)
                      : ((l =
                          (2 * f -
                        ...
                        (I >>= 8),
                        (a =
                          43690 <= (d = (u + 21845) & 65535)
                            ? l
                            : 32767 <= d
                            ? l + ((6 * (I - l) * (43690 - d) + 32768) >> 16)
                            : 10922 <= d
                            ? I
                            : l + ((6 * (I - l) * d + 32768) >> 16)),
                        (A =
          ...
          e.exports = function (t, e, i, r, n, o) {
            if (!(0 === r || n < 0.5)) {
              ...
              var a = e * i,
                ...
                l = g + u,
                I = l + h,
                d = this.__instance('unsharp_mask', A + s + 2 * u + h + 32, { exp: Math.exp }),
                m = new Uint32Array(t.buffer);
              new Uint32Array(this.__memory.buffer).set(m);
              var p = d.exports.hsl_l16 || d.exports._hsl_l16;
              p(0, f, e, i),
                (p = d.exports.blurMono16 || d.exports._blurMono16)(f, c, g, l, I, e, i, n),
                (p = d.exports.unsharp || d.exports._unsharp)(0, 0, f, c, e, i, r, o),
          ...
          e.exports = function () {
            ...
            try {
              var t = new Uint8Array([
                  0, 97, 115, 109, 1, 0, 0, 0, 1, 6, 1, 96, 1, 127, 1, 127, 3, 2, 1, 0, 5, 3, 1, 0,
                  1, 7, 8, 1, 4, 116, 101, 115, 116, 0, 0, 10, 16, 1, 14, 0, 32, 0, 65, 1, 54, 2, 0,
                  32, 0, 40, 2, 0, 11,
                ]),
                e = new WebAssembly.Module(t);
              return 0 !== new WebAssembly.Instance(e, {}).exports.test(4) && (r = !0), r;
            } catch (t) {}
            return r;
          };
        },
          ...
          e.exports = (function () {
            ...
            : function (t, e) {
                for (
                  ...
                  for (var a in (i = Object(arguments[o]))) u.call(i, a) && (n[a] = i[a]);
                  if (s) {
                    r = s(i);
                    for (var A = 0; A < r.length; A++) h.call(i, r[A]) && (n[r[A]] = i[r[A]]);
                  }
                }
                return n;
              };
      ...
      25: [
        function (t, e, i) {
          var m = arguments[3],
            ...
            B = JSON.stringify;
          e.exports = function (t, e) {
            for (var i, r = Object.keys(w), n = 0, o = r.length; n < o; n++) {
              var a = r[n],
                A = w[a].exports;
            ...
            if (!i) {
              ...
              p[i] = ['function(require,module,exports){' + t + '(self); }', s];
            }
            ...
            var I = g.createObjectURL(l),
              d = new Worker(I);
            return (d.objectURL = I), d;
          };
        },
        {},
      ],
      '/': [
        function (o, t, e) {
              ...
              (function (t, e) {
                ...
                try {
                  for (
                    ...
                    !(r = (a = A.next()).done) && (i.push(a.value), !e || i.length !== e);
                    r = !0
                  );
                } catch (t) {
                  (n = !0), (o = t);
          ...
          var n = 1;
          'undefined' != typeof navigator && (n = Math.min(navigator.hardwareConcurrency || 1, 4));
          var b,
            _,
            h = { tile: 1024, concurrency: n, features: ['js', 'wasm', 'ww'], idle: 2e3 },
            f = { quality: 3, alpha: !1, unsharpAmount: 0, unsharpRadius: 0, unsharpThreshold: 0 };
          function c() {
            return {
              value: i(r),
              destroy: function () {
          ...
          (g.prototype.init = function () {
            ...
            if (
              !1 !== b &&
              !0 !== b &&
              ((b = !1), 'undefined' != typeof ImageData && 'undefined' != typeof Uint8ClampedArray)
            )
              try {
            ...
            if (
              (0 <= i.indexOf('all') && (i = ['cib', 'wasm', 'js', 'ww']),
              (this.__requested_features = i),
              (this.__mathlib = new a(i)),
              0 <= i.indexOf('ww') && 'undefined' != typeof window && 'Worker' in window)
            )
              try {
                o('webworkify')(function () {}).terminate(), (this.features.ww = !0);
                var t = 'wp_'.concat(JSON.stringify(this.options));
                u[t]
                  ? (this.__workersPool = u[t])
                  : ((this.__workersPool = new A(c, this.options.idle)),
                    (u[t] = this.__workersPool));
              } catch (t) {}
            var r,
              n = this.__mathlib.init().then(function (t) {
              ...
              (r = _
                ? p.cib_support().then(function (t) {
                    e.features.cib && i.indexOf('cib') < 0
                      ...
                      : 0 <= i.indexOf('cib') && (e.features.cib = t);
                  })
                : Promise.resolve(!1)),
              (this.__initPromise = Promise.all([n, r]).then(function () {
                return e;
              })),
              this.__initPromise
            );
            ...
            (g.prototype.resize = function (t, o, e) {
              ...
              var a = m({}, f);
              if (
                (isNaN(e) ? e && (a = m(a, e)) : (a = m(a, { quality: e })),
                (a.toWidth = o.width),
                (a.toHeight = o.height),
                ...
                return Promise.reject(
                  new Error('Invalid output size: '.concat(o.width, 'x').concat(o.height)),
                );
              ...
              var I = Math.ceil(Math.max(3, (2.5 * a.unsharpRadius) | 0));
              return this.init().then(function () {
                if (g) return l;
                if (c.features.cib) {
                  var n = o.getContext('2d', { alpha: Boolean(a.alpha) });
                  return (
                    c.debug('Resize via createImageBitmap()'),
                    createImageBitmap(t, {
                      resizeWidth: a.toWidth,
                      resizeHeight: a.toHeight,
                      resizeQuality: p.cib_quality_name(a.quality),
                    }).then(function (t) {
                      if (g) return l;
                      if (!a.unsharpAmount)
                        return n.drawImage(t, 0, 0), t.close(), (n = null), c.debug('Finished!'), o;
                      c.debug('Unsharp result');
                      var e = document.createElement('canvas');
                      (e.width = a.toWidth), (e.height = a.toHeight);
                      var i = e.getContext('2d', { alpha: Boolean(a.alpha) });
                      i.drawImage(t, 0, 0), t.close();
                      var r = i.getImageData(0, 0, a.toWidth, a.toHeight);
                      return (
                ...
                function h(o, i, a) {
                  function r(n) {
                    return c.__limit(function () {
                      ...
                      var r;
                      if (p.isCanvas(o))
                        c.debug('Get tile pixel data'),
                          (r = A.getImageData(n.x, n.y, n.width, n.height));
                      else {
                        c.debug('Draw tile imageBitmap/image to temporary canvas');
                        var t = document.createElement('canvas');
                        (t.width = n.width), (t.height = n.height);
                        var e = t.getContext('2d', { alpha: Boolean(a.alpha) });
                        (e.globalCompositeOperation = 'copy'),
                          e.drawImage(s || o, n.x, n.y, n.width, n.height, 0, 0, n.width, n.height),
                          c.debug('Get tile pixel data'),
                          ...
                          .then(function () {
                            return (function (t) {
                              return Promise.resolve().then(function () {
                                return c.features.ww
                                  ? new Promise(function (e, i) {
                                      var r = c.__workersPool.acquire();
                                      l &&
                                        l.catch(function (t) {
                                          return i(t);
                                        }),
                                        (r.value.onmessage = function (t) {
                                          r.release(),
                                            t.data.err ? i(t.data.err) : e(t.data.result);
                                        }),
                                        r.value.postMessage(
                                          {
                                            opts: t,
                                            features: c.__requested_features,
                                            preload: { wasm_nodule: c.__mathlib.__ },
                                          },
                                          [t.src.buffer],
                                        );
                                    })
                                  : c.__mathlib.resizeAndUnsharp(t, f);
                              });
                            })(i);
                          })
                          .then(function (t) {
                            ...
                            var e;
                            if (
                              ((r = null), c.debug('Convert raw rgba tile result to ImageData'), b)
                            )
                              e = new ImageData(new Uint8ClampedArray(t), n.toWidth, n.toHeight);
                            else if ((e = u.createImageData(n.toWidth, n.toHeight)).data.set)
                              e.data.set(t);
                            else for (var i = e.data.length - 1; 0 <= i; i--) e.data[i] = t[i];
                            return (
                              c.debug('Draw tile'),
                              B
                                ? u.putImageData(
                  ...
                  return Promise.resolve()
                    .then(function () {
                      if (((u = i.getContext('2d', { alpha: Boolean(a.alpha) })), p.isCanvas(o)))
                        return (A = o.getContext('2d', { alpha: Boolean(a.alpha) })), null;
                      if (p.isImage(o))
                        return _
                          ? (c.debug('Decode image via createImageBitmap'),
                            createImageBitmap(o).then(function (t) {
                              s = t;
                            }))
                          : null;
                ...
                return (function t(e, i, r, n) {
                  ...
                  return (
                    (n = m({}, n, {
                      toWidth: A,
                      toHeight: s,
                      quality: u ? n.quality : Math.min(1, n.quality),
                    })),
                    u || (((o = document.createElement('canvas')).width = A), (o.height = s)),
                    h(i, u ? r : o, n).then(function () {
                      return u ? r : ((n.width = A), (n.height = s), t(e, o, r, n));
                    })
                  );
                })(s(a.width, a.height, a.toWidth, a.toHeight, c.options.tile, I), t, o, a);
              });
            }),
              ...
              return (
                ...
                new Promise(function (e) {
                  if (o.toBlob)
                    ...
                    for (
                      var t = atob(o.toDataURL(a, A).split(',')[1]),
                        i = t.length,
                        r = new Uint8Array(i),
                        n = 0;
                      n < i;
