    ...
    return html`
      ...
      <div class="message-form">
        <form autocomplete="off" onSubmit=${e => this.onMsgFormSubmit(e)}>
          ...
          <input onInput=${e => this.onMsgTextInput(e)} autofocus id="new-msg" type="text" placeholder="${t('type_a_message')}" autocomplete="off" autocorrect="off" autocapitalize="sentences" spellcheck="off"/>
          ${submitButton}
        </form>
      </div>`;
    }
