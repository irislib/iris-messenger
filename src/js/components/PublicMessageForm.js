...
class PublicMessageForm extends Component {
  ...
  render() {
    ...
    return html`<form autocomplete="off" class="message-form ${this.props.class || ''} public" onSubmit=${e => this.onMsgFormSubmit(e)}>
      ...
      `: ''}
      <textarea onPaste=${e => this.onMsgTextPaste(e)} onInput=${e => this.onMsgTextInput(e)} ref=${this.newMsgRef} class="new-msg" type="text" placeholder="${t(textareaPlaceholder)}" autocomplete="off" autocorrect="off" autocapitalize="sentences" spellcheck="off"/>
      <div>
