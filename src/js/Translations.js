...
"ru": {
    ...
    beware_of_sharing_chat_link_publicly: "Аккуратно распространяйте вашу ссылку на чат: вас могут заспамить сообщениями. Лучше расшарьте ссылку на <a class=\"profile-link\">ваш профиль</a>.",
    your_chat_links: "Ссылки на ваши чаты",
    create_new_chat_link: "Создать новую ссылку на чат",
    copy_your_chat_link: "Скопировать вашу ссылку на чат",
    have_someones_chat_link: "Есть чья-то ссылка на чат?",
    paste_their_chat_link: "Вставьте свою ссылку на чат",
    give_your_chat_link: "Дайте свою ссылку на чат:",
    ...
    new_participants_chat_link: "Ссылка на чат для нового участника",
  ...
  "zh-cn":{
    ...
    new_chat: "新的会话",
    if_other_person_doesnt_see_message: "如果其他人无法看到你的消息，你可以把 <b>你的</b> 会话链接在其他频道发送给他们:",
    type_a_message: "请输入消息",
    beware_of_sharing_chat_link_publicly: "请注意，公开分享你的聊天链接将有可能让你收到垃圾消息申请。推荐分享你的<a class=\"profile-link\">账号链接</a>。",
    your_chat_links: "你的聊天链接",
    create_new_chat_link: "创建新的聊天链接",
    copy_your_chat_link: "复制你的聊天链接",
    have_someones_chat_link: "有其他人的聊天链接?",
    paste_their_chat_link: "请将聊天链接粘贴在此",
    give_your_chat_link: "展示你的聊天链接:",
    ...
    donate: "Donate",
    donate_info: "<b>捐款</b>可以帮助我们继续更好地开发。 你可以通过 <a href=\"https://opencollective.com/iris-social\">Open Collective</a>或<b>比特币(Bitcoin)</b>来完成捐款，非常感谢你的帮助。",
    logout_confirmation_info: "如果你不保存好你的私钥，你<b>将无法再次登录</b>。 ",
    participants: "参与者",
    admin: "管理员",
    add_participant: "添加参与者",
    new_participants_chat_link: "新加参与者的聊天链接",
    add_friend: "添加好友",
    send_message: "发送消息",
    copy_link: "复制链接",
    chat_settings: "聊天设置",
