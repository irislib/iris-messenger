export default {
  ...
  "fi": {
    ...
    beware_of_sharing_chat_link_publicly: "Varo jakamasta chat-linkkiäsi julkisesti: saatat saada viestipyyntö-spämmiä. Sen sijaan voit jakaa julkisesti <a class=\"profile-link\">profiililinkkisi</a>.",
